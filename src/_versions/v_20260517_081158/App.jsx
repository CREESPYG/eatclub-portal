...
const APP_THEME_COLORS = [
  ...
  { id: 'coral',    p: '#FF7F50', rgb: '255, 127, 80',  pc: '#FFE4D6', opc: '#3D1A00', category: 'Dynamic' },
  { id: 'purple',   p: '#9C27B0', rgb: '156, 39, 176',  pc: '#E1BEE7', opc: '#1A0026', category: 'Dynamic' },
  ...
  { id: 'teal',     p: '#009688', rgb: '0, 150, 136',   pc: '#B2DFDB', opc: '#00201C', category: 'Simple' },
  { id: 'yellow',   p: '#FFEB3B', rgb: '255, 235, 59',  pc: '#FFF9C4', opc: '#332B00', category: 'Simple' },
  ...
  { id: 'ocean',    p: '#0D47A1', rgb: '13, 71, 161',    pc: '#BBDEFB', opc: '#000D26', category: 'Pro' },
  { id: 'cherry',   p: '#B71C1C', rgb: '183, 28, 28',   pc: '#FFCDD2', opc: '#2D0000', category: 'Pro' },
];
    ...
    <div className="app-shell">
      ...
      {showSettings && (
        <div className="contact-modal-overlay" onClick={() => setShowSettings(false)}>
          <div className="contact-card" onClick={e => e.stopPropagation()} style={{ maxWidth:400,borderRadius:28,overflow:'hidden',padding:0,border:'none',background:'var(--md-surface)' }}>
            <div style={{ padding:'20px 24px 16px',borderBottom:'1px solid var(--md-outline)',display:'flex',alignItems:'center',gap:10 }}>
              <span className="material-symbols-outlined" style={{ fontSize:20,color:'var(--md-primary)' }}>settings</span>
              <span style={{ fontSize:16,fontWeight:900,color:'var(--md-on-surface)' }}>Settings</span>
              <button onClick={() => setShowSettings(false)} style={{ marginLeft:'auto',width:28,height:28,borderRadius:8,border:'none',background:'none',color:'var(--md-on-surface-var)',cursor:'pointer' }}>
                <span className="material-symbols-outlined" style={{ fontSize:18 }}>close</span>
              </button>
            </div>
